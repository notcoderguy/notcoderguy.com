    ...
    <div className="">
      <div className="grid grid-cols-5 gap-2 mt-2">
        ...
        <motion.div
          ...
          className="bg-base-200 text-white rounded-3xl col-span-2">
        ...
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.5, delay: 0.5 }}
          className="bg-base-200 text-white col-span-3 rounded-3xl">
      ...
      <div className="grid grid-cols-5 gap-2 mt-2">
        ...
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.5, delay: 0.5 }}
          className="bg-base-200 text-white col-span-3 rounded-3xl pt-2">
        ...
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.5, delay: 0.5 }}
          className="bg-blue-700 hover:bg-blue-500 text-white rounded-3xl col-span-2">
