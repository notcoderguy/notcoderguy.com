  ...
  return (
    <div>
      <div className="grid grid-cols-3 gap-2 mt-2">
        <div className="bg-base-200 rounded-3xl text-white transform transition duration-500 ease-in-out col-span-2">
        ...
        <div className="bg-base-200 rounded-3xl text-white transform transition duration-500 ease-in-out">
